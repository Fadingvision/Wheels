...
var isThenable = _interopRequire(require("./promises/util"));
...
function resolvePromise(promise2, x, resolve, reject) {
    ...
    var isObject = isThenable(x); // 2.3.3
...
var _onResolvedCb = Symbol("onResolvedCb");
var _onRejectedCb = Symbol("onRejectedCb");
...
var Promise = (function () {
        ...
        var resolve = function (data) {
            ...
            setTimeout(function () {
                if (_this.status === "pending") {
                    ...
                    _this.onResolvedCb.forEach(function (cb) {
                        // 这里每个函数都是传入的data
                        // 不是应该传入上一个回调函数的返回值？？？
        ...
        var reject = function (reason) {
            setTimeout(function () {
                if (_this.status === "pending") {
                    ...
                    _this.data = reason;
                    _this.onRejectedCb.forEach(function (cb) {
                        return cb(reason);
                    });
                }
            }, _this.asynchronousTime);
    ...
    _prototypeProperties(Promise, {
        ...
        then: {
             ...
             */
            value: function then(resolvedCb, rejectedCb) {
